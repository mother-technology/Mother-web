    ...
    <div>
      ...
      <div className="side-margin">
        <div className="flex main">
          <p>
            More than just a team, we are a tight-knit family with deep roots.
            We formed the company in 2019 with the goal of developing novel
            tools for developing mental resilience. We believe our diversity of
            skillsets is one of our strongest assets, giving us a high level of
            insight for innovation as well as making every workday a rewarding
            challenge.
          </p>
        </div>
        ...
        <div className="flex persons">
          ...
          >
            <>
              ...
              <p className="small">
                He jumped off his postdoc to start-up when his research linked
                to branching morphogenesis suggested that immersive VR could
                alter mental states in a long-term and beneficial way.
              </p>
            </>
          </PanelPerson>
          <PanelPerson
          ...
          >
            <>
              ...
              <p className="small">
                Her broad technical experience, marketing capabilities and
                adaptability make her exceptionally well equipped for handling a
          ...
          >
            <>
              <p className="small">
                Ana is a Portuguese biochemist/neurobiologist with nine years of
                post-doctoral research experience from University of Cambridge
                and the Karolinska Institutet.
              </p>{" "}
              <p className="small">
                Recently trained in business and innovation and currently
                working in scientific communications at iBET, Portugal, Ana is a
                true people person and natural communicator and will act as our
                CMO.
              </p>
            </>
          </PanelPerson>
        ...
        <div className="flex main">
          ...
          <p>
            ...
            are, giving them freedom to work on what they think is important.
            It's not just the morally right thing to do, it's the best game
            theory model for success.
          </p>
          <p>
            We also promise to treat our customers with care and respect, to
            take a strong and diametrically opposing stance to the current norm
            of customer data monetisation, and to maintain a strict privacy and
            security discipline. Consumers today hunger for companies that
            follow through on their word, act sincerely and with integrity, with
            a focus on sustainability and humanitarianism. We promise to never
            sacrifice these values.
          </p>
          <p>
            We are determined to act in a socially responsible way, to
            prioritise the needs and values of the societies we operate in, and
            to care proactively for the planet. This doesn't just mean
            vegetarian lunches and taking the train instead of a flight, but in
            proactively taking a environmentally conscious stance, and leading
            by example.
          </p>
          <p>
        ...
        <div className="flex main">
          ...
          <p>
            ...
            XR. And we like research in neuroscience, neural nets, graph theory,
