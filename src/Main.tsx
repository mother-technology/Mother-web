                ...
                <div className="side-margin">
                        ...
                        <Panel header="The target" backgroundColor="black">
                            <>
                                <p className="small">
                                    ...
                                    functioning. We want your brain (and body)
                                    happily ticking along like a Swiss watch. We
                                    want you to feel like every day is the best
                                    day of your life, until tomorrow...
                                </p>
                                <p className="small">
                    ...
                    <div className="flex main">
                        ...
                        <p>
                            ...
                            hidden aspects of the brain, and that we are
                            approaching a new dawn for digital mental health
                            therapeutics, and we aim to be at the forefront of
                            these developments.
                        </p>
                    </div>
                    ...
                    <div className="flex panel-sell-items">
                        ...
                        >
                            <>
                                <p className="small">
                                    Work on your vagus nerve. Became a more calm
                                    person.
                                </p>
                            </>
                        </PanelSellItem>
